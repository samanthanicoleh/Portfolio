  ...
  return (
    <div className="main-about">
      ...
      <div className="technologies-section">
        ...
        <img className="techlogos" src={ReactLogo} alt="React Logo" />
        <img className="techlogos" src={BootstrapLogo} alt="Bootstrap Logo" />
        <img className="techlogos" src={NodeLogo} alt="Node JS Logo" />
        <img className="techlogos" src={PHPLogo} alt="PHP Logo" />
        ...
        <img className="techlogos" src={JavaLogo} alt="Java Logo" />
          ...
          <Row>
              ...
              <div classname="pet-section">
                <div className="favourites">
                  <FontAwesomeIcon
                    ...
                    icon={faPaw}
                  />
                  <p className="aboutme-title">{content.aboutpage.favouritesheaders[0]}</p>
                </div>
                <div className="hide">
                  <img
            ...
            <Col>
              <div classname="hobbies-section">
                <div className="favourites">
                  <FontAwesomeIcon className="aboutme-icon hobby-icon" icon={faHobby} />
                  <p className="aboutme-title">{content.aboutpage.favouritesheaders[1]}</p>
                </div>
                <div className="hide">
                  <img
                    className="hiddenimg"
           ...
           <Row className="second-row">
              ...
              <div classname="languages-section">
                <div className="favourites">
                  <FontAwesomeIcon
                    ...
                    icon={faLanguage}
                  />
                  <p className="aboutme-title bottom-title">{content.aboutpage.favouritesheaders[2]}</p>
                </div>
                <div className="hide">
                  <img
                    className="hiddenimg"
            ...
            <Col>
              <div classname="favourites-section">
                <div className="favourites">
                  <FontAwesomeIcon className="aboutme-icon bottom-icon" icon={faStar} />
                  <p className="aboutme-title bottom-title">{content.aboutpage.favouritesheaders[3]}</p>
                </div>
                <div className="hide">
                  <div className="hiddenimg" style={{'backgroundColor': '#800d91'}}></div>
                  <img
                    className="hiddenimg medo"
                    src={DogImage}
                    alt="Image of dog."
